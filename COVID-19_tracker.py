# -*- coding: utf-8 -*-
"""
Created on Thu Jun 23 18:13:34 2022

@author: Abhinav Bhamidipati
"""

import dash #defining app
import dash_html_components as html #setting layout
...
COVID_IMG = "https://indianewsdiary.com/wp-content/uploads/2021/04/hu.png"
...
body_app = dbc.Container([
    ...
    dbc.Row( html.Marquee("Stay Safe and follow all the COVID guidelines"), style = {'color':'green'}),
    ...
    dbc.Row( html.Marquee("Dashboard Made by Abhinav Bhamidipati"), style = {'color':'blue'})
